...
$profdn	= '/novdisk2/db/omopdb/profk';
$dbfn	= "/novdisk2/db/omopdb/profdbkgz_$mode.sqlite";
$timefn	= "/novdisk2/db/omopdb/datatimekgz_$mode.json.gz";
